  ...
  landingPage: async (req, res) => {
    try {
      ...
      const testimonial = {
        ...
        name: "Liburan Dengan Keluarga",
        rate: 4.55,
        content:
          "Pelayanan yang sangat baik dan juga sangat cepat untuk proses pemesanannya......",
        familyName: "Jaelani",
        familyOccupation: "Pemesan",
      };
  ...
  detailPage: async (req, res) => {
    try {
      ...
      const testimonial = {
        ...
        rate: 5,
        content:
          "Hotel ini sangat cocok untuk saya dan keluarga saya selama berlibur di malang dan sangat keren",
        familyName: "Fuad",
        familyOccupation: "Pelanggan",
      };
